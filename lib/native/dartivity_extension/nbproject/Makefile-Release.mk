...
${OBJECTDIR}/ExtResource.o: ExtResource.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ExtResource.o ExtResource.cpp

${OBJECTDIR}/dartivity_extension.o: dartivity_extension.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dartivity_extension.o dartivity_extension.cpp
